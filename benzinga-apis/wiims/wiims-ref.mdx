---
title: 'NSE/BSE WIIMs API Reference'
...
`/wiims?updated=LAGGED_TIMESTAMP` Where `LAGGED_TIMESTAMP` is set to be five seconds less than the maximum value of the updated field in rows already pulled from our API.
